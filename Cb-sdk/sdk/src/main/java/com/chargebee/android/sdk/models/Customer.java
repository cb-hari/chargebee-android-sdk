...
public class Customer extends Resource<Customer> {
    ...
    public static class PaymentMethod extends Resource<PaymentMethod> {
        public enum Type {
             CARD,PAYPAL_EXPRESS_CHECKOUT,AMAZON_PAYMENTS,DIRECT_DEBIT,GENERIC,ALIPAY,UNIONPAY,
            _UNKNOWN; /*Indicates unexpected value for this enum. You can get this when there is a
            java-client version incompatibility. We suggest you to upgrade to the latest version */ 
        }
    ...
    public static class CreateRequest extends Request<CreateRequest> {
        ...
        public CreateRequest taxability(com.chargebee.android.sdk.models.enums.Taxability taxability) {
        ...
        public CreateRequest entityCode(com.chargebee.android.sdk.models.enums.EntityCode entityCode) {
    ...
    public static class CustomerListRequest extends ListRequest<CustomerListRequest> {
        ...
        public EnumFilter<com.chargebee.android.sdk.models.enums.AutoCollection, CustomerListRequest> autoCollection() {
            return new EnumFilter<com.chargebee.android.sdk.models.enums.AutoCollection, CustomerListRequest>("auto_collection",this);
        }


        public EnumFilter<com.chargebee.android.sdk.models.enums.Taxability, CustomerListRequest> taxability() {
            return new EnumFilter<com.chargebee.android.sdk.models.enums.Taxability, CustomerListRequest>("taxability",this);
        }
    ...
    public static class UpdateRequest extends Request<UpdateRequest> {
        ...
        public UpdateRequest autoCollection(com.chargebee.android.sdk.models.enums.AutoCollection autoCollection) {
            params.addOpt("auto_collection", autoCollection);
            return this;
        }
        ...
        public UpdateRequest taxability(com.chargebee.android.sdk.models.enums.Taxability taxability) {
            params.addOpt("taxability", taxability);
            return this;
        }
        ...
        public UpdateRequest entityCode(com.chargebee.android.sdk.models.enums.EntityCode entityCode) {
            params.addOpt("entity_code", entityCode);
            return this;
        }
    ...
    public static class UpdatePaymentMethodRequest extends Request<UpdatePaymentMethodRequest> {
        ...
        public UpdatePaymentMethodRequest paymentMethodType(com.chargebee.android.sdk.models.enums.Type paymentMethodType) {
            params.add("payment_method[type]", paymentMethodType);
            return this;
        }

        @Deprecated
        public UpdatePaymentMethodRequest paymentMethodGateway(com.chargebee.android.sdk.models.enums.Gateway paymentMethodGateway) {
            params.addOpt("payment_method[gateway]", paymentMethodGateway);
            return this;
        }
    ...
    public static class UpdateBillingInfoRequest extends Request<UpdateBillingInfoRequest> {
        ...
        public UpdateBillingInfoRequest billingAddressValidationStatus(com.chargebee.android.sdk.models.enums.ValidationStatus billingAddressValidationStatus) {
            params.addOpt("billing_address[validation_status]", billingAddressValidationStatus);
            return this;
        }
    ...
    public static class AssignPaymentRoleRequest extends Request<AssignPaymentRoleRequest> {
        ...
        public AssignPaymentRoleRequest role(com.chargebee.android.sdk.models.enums.Role role) {
    ...
    public static class AddPromotionalCreditsRequest extends Request<AddPromotionalCreditsRequest> {
        ...
        public AddPromotionalCreditsRequest creditType(com.chargebee.android.sdk.models.enums.CreditType creditType) {
    ...
    public static class DeductPromotionalCreditsRequest extends Request<DeductPromotionalCreditsRequest> {
        ...
        public DeductPromotionalCreditsRequest creditType(com.chargebee.android.sdk.models.enums.CreditType creditType) {
            params.addOpt("credit_type", creditType);
            return this;
        }
    ...
    public static class SetPromotionalCreditsRequest extends Request<SetPromotionalCreditsRequest> {
        ...
        public SetPromotionalCreditsRequest creditType(com.chargebee.android.sdk.models.enums.CreditType creditType) {
            params.addOpt("credit_type", creditType);
            return this;
        }
    ...
    public static class RecordExcessPaymentRequest extends Request<RecordExcessPaymentRequest> {
        ...
        public RecordExcessPaymentRequest transactionPaymentMethod(com.chargebee.android.sdk.models.enums.PaymentMethod transactionPaymentMethod) {
