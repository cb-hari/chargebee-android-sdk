...
public class Transaction extends Resource<Transaction> {
    ...
    public static class TransactionListRequest extends ListRequest<TransactionListRequest> {
        ...
        public EnumFilter<com.chargebee.android.sdk.models.enums.PaymentMethod, TransactionListRequest> paymentMethod() {
            return new EnumFilter<com.chargebee.android.sdk.models.enums.PaymentMethod, TransactionListRequest>("payment_method",this);
        }


        public EnumFilter<com.chargebee.android.sdk.models.enums.Gateway, TransactionListRequest> gateway() {
            return new EnumFilter<com.chargebee.android.sdk.models.enums.Gateway, TransactionListRequest>("gateway",this);
        }
